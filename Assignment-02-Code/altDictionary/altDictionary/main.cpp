...
//  altDictionary
//
//  Created by Melissa Estrada on 3/10/19.
...
int main() {
    ...
    for (string entry : tokens) {
        ...
        string a, speech, definitions, distinct;
        ...
        while (getline(test, a, '|')) {
            ...
            distinct = a.substr(0, a.find_first_of(" "));
            distinct[0] = toupper(distinct.at(0));
...
string getInput() {
    ...
    while (input.empty()) {
        cout << setw(6) << "|" << endl;
        cout << "         " << "<Please enter a search key and or a part of speechdidnt>" << endl;
        cout << setw(6) << "|" << endl;
        cout << "Search: ";
        getline(cin, input);
    }
    ...
    switch (searchKeys.size())
    {
        ...
        case 3:
            ...
            if (searchKeys[1] == "distinct") {
                ...
                cout << "         " << "<3nd argument must be distinct.>" << endl;
                cout << setw(9) << "|" << endl;
                return;
            }
            break;
        ...
        default:
            cout << setw(6) << "|" << endl;
            cout << "         " << "<Please enter a search key or a part of speech.>" << endl;
            cout << setw(6) << "|" << endl;
            return;
    }
